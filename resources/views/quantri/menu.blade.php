<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="{{route('quantri.settings.index')}}"><i class="fa fa-users fa-fw"></i> Cấu hình</a>
            </li>
            <li>
                <a href="#"><i class="fa fa-users fa-fw"></i> Người dùng<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{route('quantri.users.index')}}">Danh sách người dùng</a>
                        <a href="{{route('quantri.users.create')}}">Thêm người dùng mới</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            @endif
            @if(auth()->user()->vaitro->ten == 'Quản trị viên' || auth()->user()->vaitro->ten == 'Ứng viên' )
            <li>
            ...
            @endif
            @if(auth()->user()->vaitro->ten == 'Quản trị viên' || auth()->user()->vaitro->ten == 'Nhân viên' )
            <li>
           ...
           @if(auth()->user()->vaitro->ten == 'Quản trị viên')
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    @if(auth()->user()->vaitro->ten == 'Quản trị viên')
                    <li>
                        <a href="{{route('quantri.vaitros.index')}}">Danh sách vai trò</a>
                        <a href="{{route('quantri.vaitros.create')}}">Thêm vai trò mới</a>
                    </li>
                    @endif
                </ul>
                <!-- /.nav-second-level -->
