...
@section('content')
    <div class="inner-header">
        <div class="container">
            <div class="pull-left">
                <h6 class="inner-title">tin tuyển dụng {{$nganh_tintuyendungs->ten}}</h6>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <div class="beta-products-list">
                            <h4>Tin tuyển dụng {{$nganh_tintuyendungs->ten}}</h4>
                            ...
                            <div class="row">
                                @foreach($tintuyendung_theonganhs as $tintuyendung_theonganh)
                                    <div class="col-sm-4">
