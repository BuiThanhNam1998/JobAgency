                        ...
                        <div class="column" style="text-align: left;color: #565656;font-size: 14px;line-height: 21px;font-family: Georgia,serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #555;font-size: 17px;line-height: 26px;font-family: calibri,carlito,pt sans,trebuchet ms,sans-serif;"><span class="font-calibri">Thông báo đến bạn <strong>{{$hoso->ten}}</strong> buổi phỏng vấn vào vị trí <strong>{{$tintuyendung->tieude}}</strong>, ngành/lĩnh vực <strong>{{$tintuyendung->nganh->ten}}</strong> của bạn diễn ra lúc: {{$lichhen->thoigian}}. Đã bị hủy.</span></h2>
                                </div>
                            </div>
