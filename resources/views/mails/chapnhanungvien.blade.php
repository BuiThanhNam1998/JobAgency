                        ...
                        <div class="column" style="text-align: left;color: #565656;font-size: 14px;line-height: 21px;font-family: Georgia,serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #555;font-size: 17px;line-height: 26px;font-family: calibri,carlito,pt sans,trebuchet ms,sans-serif;"><span class="font-calibri">Xin chúc mừng bạn <strong>{{$hoso->ten}}</strong> đã trở thành một thành viên chính thức của gia đình CADS!</span></h2><h3 style="Margin-top: 16px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #555;font-size: 16px;line-height: 24px;font-family: calibri,carlito,pt sans,trebuchet ms,sans-serif;"><span class="font-calibri">Bộ phận tuyển dụng công ty chúng tôi sẽ liên lạc để sắp xếp công việc với bạn trong thời gian sớm nhất. </span></h3>
                                </div>
                            </div>
