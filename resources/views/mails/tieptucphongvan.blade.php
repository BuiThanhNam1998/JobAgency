            ...
            <div role="banner">
                ...
                <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);" id="emb-email-header-container">
                    ...
                    <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 0px;Margin-bottom: 0px;color: #41637e;font-family: Avenir,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                        <div class="logo-center" align="center" id="emb-email-header"><a style="text-decoration: none;transition: opacity 0.1s ease-in;color: #41637e;" href="https://www.cads.com.vn/"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 230px;" src="https://i.imgur.com/LXjO8Wi.png" alt="Chào mừng bạn đã đến với CADS!" width="230" /></a></div>
                    </div>
                    <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                </div>
            </div>
                    ...
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;">
                        ...
                        <div class="column" style="text-align: left;color: #565656;font-size: 14px;line-height: 21px;font-family: Georgia,serif;">
                            ...
                            <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                                <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #41637e;" href="https://www.cads.com.vn/"><img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;display: block;height: auto;width: 100%;max-width: 875px;" alt="Chào mừng bạn đã đến với CADS!" width="600" src="https://i.imgur.com/W7tnDDV.png" /></a>
                            </div>

                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #555;font-size: 17px;line-height: 26px;font-family: calibri,carlito,pt sans,trebuchet ms,sans-serif;"><span class="font-calibri">Chúng tôi xin chúc mừng bạn <strong>{{$hoso->ten}}</strong> buổi phỏng vấn ngày {{$lichhen->thoigian}} của bạn đã đạt kết quả rất khả quan. Đơn ứng tuyển vào vị trí <strong>{{$tintuyendung->tieude}}</strong>, ngành/lĩnh vực <strong>{{$tintuyendung->nganh->ten}}</strong> của bạn sẽ cần trải qua thêm một buổi phỏng vấn quan trọng nữa.</span></h2><h3 style="Margin-top: 16px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #555;font-size: 16px;line-height: 24px;font-family: calibri,carlito,pt sans,trebuchet ms,sans-serif;"><span class="font-calibri">Bộ phận tuyển dụng công ty chúng tôi sẽ liên lạc để sắp xếp lịch phỏng vấn với bạn trong thời gian sớm nhất. </span></h3>
                                </div>
                            </div>
                            ...
                            <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Georgia,serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
                                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                    <table class="email-footer__links" style="border-collapse: collapse;table-layout: fixed;" role="presentation" emb-web-links><tbody><tr role="navigation">
                                            <td style="padding: 0;width: 26px;" emb-web-links><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="https://www.facebook.com/PhanMemKeToanCADS/"><img style="border: 0;" src="https://i2.createsend1.com/static/eb/master/13-the-blueprint-3/images/facebook.png" width="26" height="26" alt="Facebook" /></a></td><td style="padding: 0 0 0 3px;width: 26px;" emb-web-links><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="https://www.youtube.com/channel/UCHRFUSgFftK5g3o9cF1WNnA"><img style="border: 0;" src="https://i4.createsend1.com/static/eb/master/13-the-blueprint-3/images/youtube.png" width="26" height="26" alt="YouTube" /></a></td>
                                        </tr></tbody></table>
                                    <div style="font-size: 12px;line-height: 19px;Margin-top: 20px;">
                                        <div>Công ty Cổ phần Phần mềm CADS - CADS Software<br />
                                            Trụ sở và các văn phòng: tại Hà Nội và TP. Hồ Chí Minh:<br />
                                            -&nbsp; Văn phòng tại TP Hà Nội:<br />
                                            &nbsp;  Phòng 4B, Tòa nhà ICC, Số 1277 đường Giải Phóng, Q. Hoàng Mai - ĐT: (024) 3641 3449 - Email: info@cads.com.vn<br />
                                            -&nbsp; Văn phòng tại TP Hồ Chí Minh:<br />
                                            &nbsp; &nbsp;Lầu 3, 289 Đinh Bộ Lĩnh, phường 26, Q. Bình Thạnh - ĐT: (028) 3914 3786 - Email: sale@cads.com.vn<br />
                                            -&nbsp; Tổng đài CSKH: 1900 1294  -  Hotline: 090 340 2799</div>
                                    </div>
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                    <div class="footer__share-button">
                                        <div style="Margin-bottom: 6px;mso-line-height-rule: exactly;">
                                            <fblike style="border-radius: 2px;color: #ffffff;display: inline-block;font-size: 11px;font-weight: bold;line-height: 19px;text-align: left;text-decoration: none;border-style: solid;border-width: 4px 7px 3px 4px;mso-border-width-alt: 4px 8px 8px 8px;background-color: #7e7e7e;border-color: #7e7e7e;mso-border-color-alt: #7e7e7e;" likeurl="https://www.facebook.com/PhanMemKeToanCADS/">
